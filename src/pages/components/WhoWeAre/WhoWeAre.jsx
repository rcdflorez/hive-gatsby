    ...
    <Row className="container-weAre">
      ...
      <Col className="weAre-data col-12 col-lg-6">
        ...
        <div className="weAre-info">
          <p>
            HFS core advantage lies in our leadership team's extensive
            experience. We are supported with cutting edge technology for
            marketing, underwriting, scoring and loan management.
          </p>
        </div>
